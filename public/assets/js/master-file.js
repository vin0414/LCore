...
$(document).on("click", ".newAssignment", function () {
    var confirmation = confirm(
        "Do you want to assign this employee with new assignment?"
    );
    if (confirmation) {
...
$(document).on("click", ".salaryAdjusment", function () {
    var confirmation = confirm(
        "Would you like to apply salary adjustment with this employee?"
    );
    if (confirmation) {
...
// New Leave Policy
$(document).on("click", ".newPolicy", function () {
    $("#newPolicyModal").css("display", "flex");
    $("body").addClass("no-scroll");
});

function closePolicyModal() {
    $("#newPolicyModal").css("display", "none");
    $("body").removeClass("no-scroll");
}
// New Leave Policy End

// Edit leave policy
$(document).on("click", ".edit__policy", function () {
    $("#editPolicyModal").css("display", "flex");
    $("body").addClass("no-scroll");
});

function closeEditPolicyModal() {
    $("#editPolicyModal").css("display", "none");
    $("body").removeClass("no-scroll");
}
// Edit leave policy end

// Type of Leave
$(document).on("click", ".newTypeOfLeave", function () {
    $("#newTypeOfLeave").css("display", "flex");
    $("body").addClass("no-scroll");
});

function closeTypeOfLeave() {
    $("#newTypeOfLeave").css("display", "none");
    $("body").removeClass("no-scroll");
}
// Type of Leave end

// EditType of Leave
$(document).on("click", ".edit__type__leave", function () {
    $("#editTypeOfLeave").css("display", "flex");
    $("body").addClass("no-scroll");
});

function closeEditTypeOfLeave() {
    $("#editTypeOfLeave").css("display", "none");
    $("body").removeClass("no-scroll");
}
// Edit Type of Leave end
