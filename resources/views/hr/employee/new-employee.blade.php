    ...
    <main>
      ...
      <div class="container">
        <div class="heading__box flex flex__align__center">
          ...
          <p class="pages"><a href="{{route('hr/employee')}}" class="link__breadcrumbs">Master File</a><ion-icon name="chevron-forward-outline"></ion-icon><span class="breadcrumbs__right__text">New Employee</span></p>
          </div>
        </div> 
