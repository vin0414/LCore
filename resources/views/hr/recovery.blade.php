    ...
    <main>
      ...
      <div class="container">
        ...
        <div class="cards grid grid__2__cols">
            <div class="card">
                <h3 class="card-title"><ion-icon name="cloud-upload-outline"></ion-icon>&nbsp;Restore</h3>
                <hr/>
            </div>
            <div class="card">
                <h3 class="card-title"><ion-icon name="cloud-download-outline"></ion-icon>&nbsp;Back-Up</h3>
                <hr/>
                <div class="text-muted"><small>Backing up collected data is an important part of data management. Backups protect against human error, hardware failure, virus attacks, power outages and natural disasters.</small></div>
            </div>
        </div>
      </div>
    </main>
